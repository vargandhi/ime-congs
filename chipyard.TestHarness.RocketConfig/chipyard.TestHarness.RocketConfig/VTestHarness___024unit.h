...
VL_MODULE(VTestHarness___024unit) {
  ...
  public:
    ...
    void __Vdpiimwrap_memory_init_TOP____024unit(const QData/*63:0*/ mem_size, const QData/*63:0*/ word_size, const QData/*63:0*/ line_size, const QData/*63:0*/ id_bits, QData/*63:0*/(&  memory_init__Vfuncrtn));
